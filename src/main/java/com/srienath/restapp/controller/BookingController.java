...
//	        int connectionID = booking.getConnectionRequest().getConnectionID();
//	        Booking connectionRequest = bookingService.getBookingByConnectionId(connectionID);
//	        if (connectionRequest == null || connectionRequest.getConnectionRequest() == null) {
//	            return ResponseEntity.status(HttpStatus.NOT_FOUND).body("Connection Request not found or invalid.");
//	        }
//	        if (!"Approved".equalsIgnoreCase(connectionRequest.getConnectionRequest().getStatus())) {
//	            return ResponseEntity.status(HttpStatus.FORBIDDEN).body("You must have an approved connection to book a cylinder.");
//	        }
